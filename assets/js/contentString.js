const contentString = (truck) = {
  str =
    '<div>' +
  '<div class="px-4 sm:px-0">' +
    '<h3 class="text-base font-semibold leading-7 text-gray-900">' + 'Applicant</h3>' +
    '<p class="mt-1 max-w-2xl text-sm leading-6 text-gray-500">' + truck.applicant.  + '</p>' +
  '</div>'
...
const contentString_orig = '<div id="content">' +
'<div id="siteNotice">' +
"</div>" +
'<h1 id="firstHeading" class="firstHeading"><%= first.applicant %></h1>' +
'<div id="bodyContent">' +

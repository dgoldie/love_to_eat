defmodule LoveToEatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LoveToEatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LoveToEatWeb.Gettext, "errors", msg, opts)
    end
  end
